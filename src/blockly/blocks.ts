...
// ============================================================
//  BerryBot Blokları — Robotistan BerryBot araç kiti
//  Sabit pinli; üretilen kod berrybot.py'deki BerryBot sınıfını çağırır.
// ============================================================

// ---- Hareket ----
Blockly.Blocks['bb_move'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
    ...
    this.setNextStatement(true);
    this.setInputsInline(true);
    this.setTooltip('BerryBot\'u hareket ettirir.');
  },
};

Blockly.Blocks['bb_stop'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('BerryBot motorlarını durdurur.');
  },
};

Blockly.Blocks['bb_motors'] = {
  init: function (this: Blockly.Block) {
    this.appendValueInput('LEFT').setCheck('Number')
      .appendField('🚗 BerryBot motorlar — sol');
    ...
    this.setNextStatement(true);
    this.setInputsInline(true);
    this.setTooltip('Sol ve sağ motoru ayrı hızda sürer (-255 ile 255 arası).');
  },
};

// ---- Mesafe ----
Blockly.Blocks['bb_distance'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('📏 BerryBot mesafe (cm)');
    this.setStyle('ultra_blocks');
    this.setOutput(true, 'Number');
    this.setTooltip('Ultrasonik sensörden ölçülen mesafeyi (cm) verir.');
  },
};

// ---- Çizgi sensörü ----
Blockly.Blocks['bb_line'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('🛣️ BerryBot çizgi sensörü')
      .appendField(
        new Blockly.FieldDropdown([
          ['sol', 'cizgi_sol'],
          ['sağ', 'cizgi_sag'],
    ...
    this.setStyle('sensor_blocks');
    this.setOutput(true, 'Number');
    this.setTooltip('Çizgi takip sensörünün değerini verir (0-65535).');
  },
};

// ---- Işık (LDR) ----
Blockly.Blocks['bb_light'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('☀️ BerryBot ışık')
      .appendField(
        new Blockly.FieldDropdown([
          ['sol', 'isik_sol'],
          ['sağ', 'isik_sag'],
    ...
    this.setStyle('ldr_blocks');
    this.setOutput(true, 'Number');
    this.setTooltip('Işık (LDR) sensörünün değerini verir.');
  },
};

// ---- Buton ----
Blockly.Blocks['bb_button'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('⏺️ BerryBot butona basıldı');
    this.setStyle('button_blocks');
    this.setOutput(true, 'Boolean');
    this.setTooltip('Kart üzerindeki butona basılıysa doğru verir.');
  },
};

// ---- RGB şerit ----
Blockly.Blocks['bb_rgb_all'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('🌈 BerryBot tüm RGB')
      .appendField(new FieldColourPalette('#ff0000'), 'COLOUR');
    this.setStyle('rgb_blocks');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setInputsInline(true);
    this.setTooltip('Tüm RGB LED\'leri seçilen renge boyar.');
  },
};

Blockly.Blocks['bb_rgb_one'] = {
  init: function (this: Blockly.Block) {
    this.appendValueInput('INDEX').setCheck('Number')
      .appendField('🌈 BerryBot RGB piksel');
    this.appendDummyInput()
      .appendField('renk')
      .appendField(new FieldColourPalette('#ff0000'), 'COLOUR');
    this.setStyle('rgb_blocks');
    ...
    this.setNextStatement(true);
    this.setInputsInline(true);
    this.setTooltip('Tek bir RGB LED\'i (0-6) seçilen renge boyar.');
  },
};

Blockly.Blocks['bb_rgb_off'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('🌈 BerryBot RGB kapat');
    this.setStyle('rgb_blocks');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Tüm RGB LED\'leri söndürür.');
...
// ---- Buzzer ----
Blockly.Blocks['bb_horn'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('📢 BerryBot korna');
    this.setStyle('buzzer_blocks');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Kısa bir korna sesi çalar.');
  },
};

Blockly.Blocks['bb_buzzer'] = {
  init: function (this: Blockly.Block) {
    this.appendValueInput('FREQ').setCheck('Number')
      .appendField('🔊 BerryBot ses — frekans');
    this.appendValueInput('DUR').setCheck('Number')
      .appendField('süre (ms)');
    this.setStyle('buzzer_blocks');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setInputsInline(true);
    this.setTooltip('Belirtilen frekansta belirtilen süre kadar ses çalar.');
  },
};

// ---- LED Matris ----
Blockly.Blocks['bb_matrix_shape'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('🟥 BerryBot matris')
      .appendField(
        new Blockly.FieldDropdown([
          ['🙂 gülen', 'gulen'],
          ['🙁 üzgün', 'uzgun'],
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('5x5 LED matriste hazır bir şekil gösterir.');
  },
};

Blockly.Blocks['bb_matrix_clear'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('🟥 BerryBot matris temizle');
    this.setStyle('led_blocks');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('LED matrisi söndürür.');
  },
};

// ---- IR alıcı ----
Blockly.Blocks['bb_ir_start'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('📡 BerryBot IR alıcıyı başlat');
    this.setStyle('ir_blocks');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('IR uzaktan kumanda alıcısını başlatır. Program başında bir kez kullanılır.');
  },
};

Blockly.Blocks['bb_ir_key'] = {
  init: function (this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('📡 BerryBot IR tuşu')
      .appendField(
        new Blockly.FieldDropdown([
          ['▲ yukarı', 'number_up'],
          ['▼ aşağı', 'number_down'],
    ...
    this.setStyle('ir_blocks');
    this.setOutput(true, 'Boolean');
    this.setTooltip('Seçilen IR kumanda tuşuna basıldıysa doğru verir.');
  },
};
