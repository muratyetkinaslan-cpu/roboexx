...
const ROBOARM_STEPS: AssemblyStep[] = [
  ...
  },
  {
    ...
    subtitle: 'Gripper motorunu gövdesine 2 vidayla sabitle.',
    model: 'gripper_motor',
    steps: [
      'Siyah gripper motorunu (MG90S) gövdesine yerleştir.',
      'Parlayan 2 vidayla motoru sabitle.',
      'Motoru 90°’ye getir (kıskaç sonra yarı açık otursun).',
    ],
    parts: ['Gripper motoru (siyah)', '2× vida'],
    tip: 'Bu adımda sadece motor takılır; kıskaç ve mil bir sonraki adımda gelir.',
  },
  {
    short: 'Gripper Kıskacı',
    title: 'Kıskacı tak (mil + merkez vida)',
    subtitle: 'İki kıskaç parçasını mil (silindir) ile birleştir, ortadan tek vidayla sabitle.',
    model: 'gripper_aparat',
    steps: [
      'İki kıskaç parçasını üst üste getir; birleştikleri yere mili (silindir şaft) geçir.',
      'Kıskacı motorun miline (ortaya) oturt.',
      'Parlayan merkez vidasını ortadan tak — gripper böylece servoya bağlanır.',
    ],
    parts: ['Kıskaç parçaları', 'Mil (silindir)', '1× merkez vida'],
    tip: 'Mil iki kıskacın birleştiği noktaya girer; sonra ortadaki tek vida sıkılır.',
  },
  {
    short: 'Hazır — Dene',
