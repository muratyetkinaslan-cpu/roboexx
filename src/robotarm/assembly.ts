...
const ROBOARM_STEPS: AssemblyStep[] = [
  ...
  },
  {
    ...
    subtitle: 'Gripper motorunu gövdeye, iki yan tabındaki 2 vidayla sabitle.',
    model: 'gripper_motor',
    steps: [
      'Siyah gripper motorunu (MG90S) gövdesine yerleştir.',
      'Motorun iki yan kulağındaki (tab) parlayan 2 vidayı tak.',
      'Vidalar motoru gövdeye sabitler; çark vidaları sonraki adımda gelir.',
    ],
    parts: ['Gripper motoru (siyah)', '2× tab vidası'],
