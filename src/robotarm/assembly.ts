...
const ROBOARM_STEPS: AssemblyStep[] = [
  ...
  },
  {
    ...
    tip: 'Mil, gripper’ı bir önceki bilek parçasına birleştiren bağlantı şaftıdır; motordan önce takılır.',
  },
  {
    short: 'Gripper Motoru',
    title: 'Gripper motorunu tak',
    subtitle: 'Gripper motorunu gövdeye, iki tarafındaki 2 vidayla sabitle.',
    model: 'gripper_motor',
    steps: [
      'Siyah gripper motorunu (MG90S) gövdesine yerleştir.',
      'Servonun üst ve alt tarafındaki parlayan 2 vidayı tak.',
      '2 vida servoyu her iki taraftan sıkıca sabitler.',
    ],
    parts: ['Gripper motoru (siyah)', '2× vida'],
    tip: 'İki vida servonun iki ucundadır; biri üstte biri altta, motoru sabit tutar.',
  },
  {
