...
const ROBOARM_STEPS: AssemblyStep[] = [
  ...
  },
  {
    ...
    subtitle: 'Gripper gövdesini bilek parçasına getir; mili ikisinin ortak deliğinden geçir.',
    model: 'gripper_mil',
    steps: [
      'Gripper gövdesini, bir önceki bilek (wrist) parçasının ucuna getir.',
      'Parlayan silindir mili, iki parçanın ortak deliğine sok.',
      'Mil bir parçadan diğerine geçerek gripper’ı bileğe bağlar.',
    ],
    parts: ['Gripper gövdesi', 'Mil (silindir şaft)'],
    tip: 'Mil tek parçanın içinde değil; iki parçayı birbirine geçirerek bağlar.',
  },
  {
    short: 'Gripper Motoru',
    title: 'Gripper motorunu tak',
    subtitle: 'Gripper motorunu gövdeye, iki yan tarafındaki 2 vidayla sabitle.',
    model: 'gripper_motor',
    steps: [
      'Siyah gripper motorunu (MG90S) gövdesine yerleştir.',
      'Servonun iki yan kenarındaki parlayan 2 vidayı tak.',
      'Vidalar servoyu her iki yandan sabitler (ortaya vida gelmez).',
    ],
    parts: ['Gripper motoru (siyah)', '2× yan vida'],
    tip: 'Vidalar servonun iki yan kenarına gelir; ortasına vida takılmaz.',
  },
  {
    short: 'Çarklar (Kıskaç)',
    title: 'Çarkları tak (merkez vidası)',
    subtitle: 'İki kıskaç çarkını birbirine geçir; servonun önündeki çarkı ortasından tek vidayla sabitle.',
    model: 'gripper_aparat',
    steps: [
      'İki kıskaç çarkını birbirine geçir (dişliler kavraşsın).',
      'Servonun önündeki çarkın tam ortasına parlayan vidayı tak.',
      'Vida bu çarkı döner şekilde sabitler.',
    ],
    parts: ['Kıskaç çarkları', '1× merkez vida'],
    tip: 'Tek vida yalnız servonun önündeki çarkın ortasına gelir.',
  },
  {
    short: 'Hazır — Dene',
