...
const ROBOARM_STEPS: AssemblyStep[] = [
  ...
  },
  {
    ...
    subtitle: 'Gripper motorunu gövdeye, motor tarafındaki tek vidayla sabitle.',
    model: 'gripper_motor',
    steps: [
      'Siyah gripper motorunu (MG90S) gövdesine yerleştir.',
      'Motorun bulunduğu taraftaki parlayan vidayı tak.',
      'Diğer taraf doğrudan oturur — orada vida yoktur.',
    ],
    parts: ['Gripper motoru (siyah)', '1× vida'],
    tip: 'Tek vida motor tarafına gelir; karşı taraf vidasız, doğrudan geçer.',
  },
  {
    ...
    tip: 'Mil, gripper’ı bir önceki bilek parçasına birleştiren bağlantı şaftıdır.',
  },
  {
    ...
    tip: 'Vidalar çarkların tam ortasına gelir; çark serbest dönebilmeli.',
  },
  {
    short: 'Hazır — Dene',
